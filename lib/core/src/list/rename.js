...
export const rename = app => function(listName) {
    //@return string || string[]
    const { input: { catchInput }, config: { $input } } = app
    const listShortcut = Object.assign({}, getDefaultListShortcut(), app.config.get("list.shortcut", {}))
    const inputGetter = new InputGetter(app)
